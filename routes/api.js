...
router.get('/ng2Ajax/imgSearch/:query', function (req, res, next) {
  ...
  .then(urls => {
        if(req.params.query != 'cats'){
        res.json([
      'https://vvmdy1wnjdv42.educative.run:3000/images/'+req.params.query+'.jpg']);
     } else {
	    

res.json([
      'https://vvmdy1wnjdv42.educative.run:3000/images/cat0.jpg',
      'https://vvmdy1wnjdv42.educative.run:3000/images/cat1.jpg',
      'https://vvmdy1wnjdv42.educative.run:3000/images/cat2.jpg',
      'https://vvmdy1wnjdv42.educative.run:3000/images/cat3.jpg',
      'https://vvmdy1wnjdv42.educative.run:3000/images/cat4.jpg',
      'https://vvmdy1wnjdv42.educative.run:3000/images/cat5.jpg',
      'https://vvmdy1wnjdv42.educative.run:3000/images/cat6.jpg']);
    }
